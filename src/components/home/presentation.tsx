...
export const Presentation = () => {
    return (
        <div className="flex flex-col  lg:flex-row items-center justify-center min-h-screen md:max-w-[680px] lg:max-w-[1120px] pt-[110px]">
            ...
            <div className="flex flex-col text-center mx-4 my-4 text-[0.9rem] max-w-[480px] md:text-left text-tecs-textprimary lg:items-center items-center">
                ...
                <Button href="/sobre" className="my-6 lg:mt-8 lg:my-0 text-white">PARTICIPE</Button>
            </div>
        </div>
    )
}