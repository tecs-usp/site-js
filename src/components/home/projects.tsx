...
export const Projects = () => {
    return (
        <div id="projects" className="flex flex-col items-center justify-center min-h-screen w-full pt-[80px] bg-gradient-to-r from-tecs-secondary to-tecs-primary overflow-hidden px-6">
            <ProjectHeader />
